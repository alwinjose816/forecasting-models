from forecast_demand_regimes import run_forecast_demand_regimes
...
def run_forecast_demand_transitions(product="Overall"):

    # ==========================================
    # LOAD REGIMES
    # ==========================================

    result = run_forecast_demand_regimes(product)
