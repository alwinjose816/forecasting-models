from forecast_deep_demand_regimes import (
    run_forecast_deep_demand_regimes
)
...
def run_forecast_deep_demand_transitions(product="Overall"):

    # ==========================================
    # LOAD REGIMES
    # ==========================================

    result = run_forecast_deep_demand_regimes(
        product
    )
    ...
    # ==========================================
    # EXPECTED DURATION FEATURE
    # ==========================================

    df["expected_duration"] = (
        df["state"]
        .map(expected_duration)
    )

    # ==========================================
    # TRANSITION ENTROPY FEATURE
    # ==========================================
   ...
   # ==========================================
    ...
    deep_metrics = {
        ...
        "regime_embedding_quality":
        result["regime_embedding_quality"]
    ...
    response = {
        ...
        {
            str(k): float(v)
            for k, v in transition_entropy.items()
        },
        ...
        {
            str(k):
            float(stability[k] * expected_duration[k])
