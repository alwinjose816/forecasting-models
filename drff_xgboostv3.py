...
def run_drff_xgboostv3(
    ...
    for i in range(30):
        ...
        future_X = pd.DataFrame([{
            ...
            "shock_score":
            last_row["shock_score"],

            "z_score":
            last_row["z_score"],

            "weekly_autocorrelation":
            last_row["weekly_autocorrelation"],
            ...
            "product_entropy":
            last_row["product_entropy"],

            "transition_entropy":
            last_row["transition_entropy"],

            "transition_strength":
            last_row["transition_strength"],
